...
from definitions import (
    Biome, GameMode, HerbName, FreshkillTactic,
    Rank, Season, SortCats, SortRelationships,
    ThemeName, LanguageCode, LeaderFocus, WarriorFocus,
)
...
class Settings:
    ...
    ShowChangelogOnUpdate: bool = True
    ...
    # -------------------------------- Clan settings --------------------------------- #
    GameMode: GameMode = GameMode.UnsetGameMode
    ...
    NamesUseBiome: bool = True
    NamesUsePeltColour: bool = True
    NamesUseEyeColour: bool = True
    # TODO NamesUsePeltPattern: bool = True
    # TODO NamesUseWhitePatchPattern: bool = True
    # TODO NamesUseTortiePatches: bool = True
    NamesUseLegacy: bool = True
    NamesUseSkill: bool = True
...
class ScreenConfig:
    ...
    themes = {
        ThemeName.Light: {
            "bg_colour": (206, 194, 168),
            "vignette_alpha": 10,
            "fade_color": (150, 150, 148),
            "dropshadow_alpha": 30,
            "clan_symbol_colour": (87, 76, 45),
        },
        ThemeName.Dark: {
            "bg_colour": (57, 50, 36),
            "vignette_alpha": 50,
            ...
            "clan_symbol_colour": (239, 229, 206),
        },
        ThemeName.Debug: {
            "clan_symbol_colour": (255, 105, 180),
        }
    }

    # surface colours
    FADE_SURFACE_COLOUR: pygame.Color = (113, 113, 111) # middle grey
...
@dataclass
class CatConfig:
    # base 1 in 90 chance that a cat will generate with a permanent condition. gets modified further in code
    chance_permanent_condition: int = 90

    # 1 in 2^12 chance that a male cat will be a tortie
    tortie_chance_male: int = 8192
    # 1 in 8 chance that a female cat will be a tortie
    tortie_chance_female: int = 8
    tortie_chance_wildcard: int = 512

    # 1 in 16 chance that a cat's pelt will directly inherit an attribute of a parent's pelt
    chance_direct_inheritance: int = 16
    # base 1 in 120 chance that a cat will have heterochromia
    base_chance_heterochromia: int = 120
    """
	"cat_name_controls": {
    ...
    adolescent_age_moons: int = 6
    young_adult_age_moons: int = 12
    senior_adult_age_moons: int = 60
...
class ClanConfig:
    ...
    # 1/chance_for_df_worshippers for an NPC Clan to worship the Dark Forest, not StarClan (which will be
    #   unknown to other Clans, including the player's)
    chance_for_df_worshippers: int = 50
...
class EventConfig:
	...
	"death_related": {
		"leader_death_chance": 50, # TODO lower this
...
class BiomeConfig:
    ...
    # random.choices(
    #     population=[amount for amount in list(HuntPreyAmount) if amount is not HuntPreyAmount.UnsetPreyAmount],
    ...
    seasonal_herb_weights = {
        Biome.Forest: {
            Season.Spring: {
                HerbName.ElderLeaf: 1,
                HerbName.Cobweb: 1,
                HerbName.DaisyLeaf: 1,
                HerbName.Horsetail: 1,
                HerbName.JuniperBerry: 1,
                HerbName.LungwortLeaf: 1,
                HerbName.Mallow: 1,
                HerbName.Marigold: 1,
                HerbName.Moss: 1,
                HerbName.OakLeaf: 1,
                HerbName.RagwortLeaf: 1,
                HerbName.RaspberryLeaf: 1,
                HerbName.TansyStem: 1,
                HerbName.ThymeLeaf: 1,
                HerbName.WildGarlic: 1,
                HerbName.DandelionLeaf: 1,
                HerbName.MulleinLeaf: 1,
                HerbName.Rosemary: 1,
                HerbName.BurdockRoot: 1,
                HerbName.BlackberryLeaf: 1,
                HerbName.BetonyLeaf: 1,
                HerbName.Goldenrod: 1,
                HerbName.PoppySeed: 1,
                HerbName.PlantainFlower: 1,
                HerbName.Catmint: 1
            },
            Season.Summer: {
                HerbName.ElderLeaf: 1,
