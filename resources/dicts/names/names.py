names_dict = {
  ...
  "pelt_suffixes": {
    ...
    "Tabby": ["stripe", "feather", "leaf", "stripe", "shade", "swirl", "shadow"],
    "Marbled": ["stripe", "feather", "leaf", "stripe", "shade", "swirl"],
    ...
    "Classic": ["stripe", "feather", "leaf", "stripe", "fern", "swirl", "blotch", "shadow"],
    "Sokoke": ["stripe", "feather", "leaf", "stripe", "fern", "swirl"],
  ...
  "clan_prefixes": [
    "Air", "Ashen", "Bat", "Bleak", "Bone", "Branch", "Burn", "Burnet", "Buttercup", "Canary", "Cinder", "Cloud",
    "Cloudy", "Cotton", "Crocus", "Crow", "Dandelion", "Day", "Doe", "Dove", "Egg", "Ember", "Fig", "Fire", "Flame",
    "Flare", "Flurry", "Freeze", "Frost", "Frozen", "Ghost", "Glint", "Gossamer", "Grackle", "Hawthorn", "Heather",
    "Hickory", "Hollyhock", "Ibis", "Ice", "Icicle", "Icy", "Jasmine", "Larkspur", "Log", "Lyre", "Magpie", "Midnight",
    "Mist", "Morel", "Mulberry", "Night", "Oleander", "Orchid", "Otter", "Owl", "Pebble", "Phlox", "Pipit", "Plume",
    "Privet", "Rime", "Rock", "Rue", "Saffron", "Scale", "Scrub", "Shade", "Shadow", "Shatter", "Smoke", "Snapdragon",
    "Snow", "Snowy", "Soot", "Spindle", "Stag", "Stone", "Storm", "Sun", "Swan", "Teasel", "Tree", "Twig", "Twilight",
    "Verbena", "Vervain", "Violet", "Vole", "Warbler", "Wisp"
  ],

  "colour_prefixes": {
    "WHITE": [
      "White", "White", "Pale", "Light", "Bright", "Wisp",
      "Snow", "Snowy", "Hail", "Frost", "Frozen", "Freeze", "Ice", "Icy", "Icicle", "Blizzard", "Flurry", "Rime", "Cold", "Chill",
      "Sky", "Air", "Cloud", "Cloudy",
      "Cotton", "Hawthorn", "Laurel",
      "Milk", "Moon", "Bone", "Egg", "Ghost",
      "Swan", "Dove", "Ibis", "Privet", "Snake", "Adder",
      "Fringe"
    ],
    "PALEGREY": [
      "Gray", "Silver", "Pale", "Light", "Bright", "Ashen",
      "Cloud", "Cloudy", "Hail", "Fog", "Sky", "Moon",
      "Frost", "Ice", "Icy", "Freeze", "Frozen", "Rime", "Icicle", "Cold", "Chill",
      "Mouse", "Dove", "Pipit", "Frog",
      "Azalea", "Mistle", "Cotton", "Heather",
      "Stone", "Pebble",
      "Tufted", "Fringe"
    ],
    "SILVER": [
      "Gray", "Silver", "Silver", "Silver", "Blue", "Pale", "Gossamer", "Bleak",
      "Ice", "Icy", "Frost", "Frozen", "Freeze", "Blizzard", "Flurry", "Rime", "Cold",
      "Rain", "River", "Stone", "Pebble", "Air", "Moon",
      "Crocus", "Rue", "Mistle", "Vine", "Lilac", "Heather",
      "Ermine", "Stoat", "Gull", "Fish", "Minnow", "Pike",
      "Scale", "Glint", "Shatter", "Fringe", "Wave"
    ],
    "GREY": [
      "Gray", "Shade", "Shadow", "Bleak",
      "Ash", "Ashen", "Cinder", "Soot", "Smoke", "Smoky",
      "Rock", "Stone", "Pebble", "Boulder",
      "Fog", "Mist", "Misty", "Rain", "Storm", "Rime", "Cold",
      "Mouse", "Rat", "Dove", "Lyre", "Gull", "Pigeon", "Shrike", "Trout", "Fish", "Frog", "Toad", "Spider",
      "Plume", "Teasel", "Wisp", "Splash"
    ],
    "DARKGREY": [
      "Gray", "Shade", "Shadow", "Dark", "Night", "Twilight", "Bleak",
      "Raven", "Crow", "Magpie", "Warbler", "Pigeon", "Rat", "Bat", "Frog", "Spider",
      "Cinder", "Ash", "Ashen", "Smoke", "Smokey", "Scorch",
      "Rock", "Stone", "Pebble", "Boulder",
      "Rain", "Storm", "Splash", "Mist", "Misty",
      "Plume", "Wisp"
    ],
    "GHOST": [
      "Black", "Gray","Shade", "Shaded", "Ebony", "Dark", "Violet", "Faded", "Silver", "Pepper",
      "Char", "Charred", "Scorch",
      "Midnight", "Night", "Shadow", "Bleak",
      "Crow", "Raven", "Magpie", "Bat", "Spider",
      "Storm", "Ghost"
    ],
    "PALEGINGER": [
      "Pale", "Ginger", "Yellow", "Orange", "Ochre", "Auburn", "Honey",
      "Sun", "Sunny", "Light", "Bright", "Warm", "Dawn",
      "Sand", "Sandy",
      "Lion",
      "Phlox", "Vervain", "Daisy", "Cosmos", "Orchid", "Snapdragon", "Peach", "Foxglove", "Verbena", "Straw", "Berry",
      "Shine"
    ],
    "GOLDEN": [
      "Gold", "Golden", "Yellow", "Tawny", "Amber", "Auburn",
      "Sun", "Sunny", "Light", "Lightning", "Thunder", "Day", "Warm", "Flash", "Dawn",
      "Fig", "Peach", "Berry", "Honey", "Dandelion", "Marigold", "Daffodil", "Saffron", "Buttercup", "Straw",
      "Lion", "Canary", "Chick",
      "Glint", "Shine"
    ],
    "GINGER": [
      "Ginger", "Red", "Tawny", "Rust", "Rusty", "Plum", "Orange", "Amber", "Ochre", "Auburn",
      "Fire", "Flame", "Ember","Warm", "Burn", "Burnt", "Flare",
      "Sun", "Sunny", "Light", "Blaze", "Shine", "Dawn",
      "Fox", "Tiger", "Robin", "Larkspur", "Lyre", "Snake",
      "Primrose", "Berry", "Rose","Rowan", "Straw", "Pumpkin"
    ],
    "DARKGINGER": [
      "Ginger", "Red", "Shade", "Russet", "Orange", "Copper", "Cinnamon", "Scarlet", "Rust", "Ochre", "Auburn", "Dark",
      "Fire", "Flame", "Ember", "Burn", "Burnt", "Warm",
      "Oak", "Hollyhock", "Rowan", "Oleander", "Berry", "Pumpkin", "Burnet",
      "Fox", "Robin", "Lyre", "Spider",
      "Dawn"
    ],
    "SIENNA": [
    ...
    "LIGHTBROWN": [
      "Brown", "Pale",
      "Dawn", "Light", "Warm", "Bright",
      "Mouse", "Vole", "Robin", "Puma", "Toad",
      "Dust", "Dusty", "Sand", "Sandy", "Mud",
      "Scrub", "Velvet",
      "Hazel", "Branch", "Tree", "Root", "Bark"
    ],
    "LILAC": [
      "Pale", "Light", "Bright",
      "Mouse", "Vole", "Robin", "Frog", "Spider",
      "Dust", "Dusty", "Sand", "Sandy", "Mud",
      "Hazel", "Branch", "Warm", "Lilac", "Lavender", "Heather",
      "Dawn", "Scrub"
    ],
    "BROWN": [
      "Brown", "Dark", "Shade", "Russet", "Umber", "Shadow", "Ochre", "Auburn",
      "Oak", "Log", "Hazel", "Tree", "Twig", "Branch", "Root", "Nut", "Burnet",
      "Mouse", "Deer", "Fawn", "Doe", "Stag", "Owl", "Otter", "Vole", "Robin", "Dog", "Spider",
      "Dust", "Dusty", "Mud"
    ],
    "GOLDEN-BROWN": [
      "Brown", "Brown", "Dark", "Shade", "Russet", "Umber", "Ochre", "Auburn",
      "Tree", "Root", "Twig", "Log", "Branch", "Oak", "Hazel", "Alder", "Burnet",
      "Mouse", "Vole", "Otter", "Deer", "Fawn", "Doe", "Stag", "Lion", "Owl", "Robin", "Thrush",
      "Dust", "Dusty", "Mud",
      "Shadow", "Thrasher"
    ],
    "DARKBROWN": [
      "Brown", "Dark", "Shade",  "Shadow", "Auburn",
      "Rowan", "Oak", "Twig", "Log", "Hickory", "Branch",  "Burnet",
      "Mushroom",
      "Owl", "Robin", "Otter", "Loach", "Spider",
      "Dust", "Mud",
      "Night", "Splash"
    ],
    "CHOCOLATE": [
    "Brown", "Brown", "Dark", "Dark", "Shade", "Night", "Russet", "Rowan", "Mud", "Oak", "Twig", "Loach", "Shadow",
    "Owl", "Otter", "Log", "Hickory", "Branch", "Robin", "Umber", "Mushroom", "Dust", "Mud", "Auburn", "Burnet"
    ],
    "BLACK": [
  ...
  "loner_names": [
    ...
    "Baphomet", "Barbatuques", "Barbie", "Barker", "Barnaby", "Basil", "Bastet", "Bastion", "Bean", "Beanie Baby", "Beanie", "Beans", "Beatle", "Beau", "Beauty", "Bebe", "Bede", "Beef Stroganoff",
    "Beesechurger", "Bell", "Bella", "Bellafide", "Bellatrix", "Belle", "Bellibolt", "Bellini", "Ben", "Benito", "Bennett", "Benny", "Bentley", "Beowulf", "Berlioz", "Betelgeuse", "Beth", "Bethany",
    ...
    "Chansey", "Chanterelle", "Chaos", "Chara", "Charcoal", "Chari", "Chariklo", "Charles", "Charlie", "Charlotte", "Charm", "Charon", "Chase", "Chasing Wind", "Chayanne", "Checkers", "Cheddar",
    "Cheerio", "Cheese Beast", "Cheese", "Cheesecake", "Cheesepuff", "Cheeto Puff", "Cheeto", "Cheetoman", "Chef", "Chekhov's Gun", "Chekov", "Cherry", "Cherub", "Cherubi", "Cheshire", "Chester",
    "Chevre", "Chewie", "Chewy", "Chiaki", "Chibi", "Chica", "Chicco", "Chickpea", "Chief", "Chihiro", "Chikorita", "Chiku", "Chip", "Chiquito", "Chispa", "Chloe", "Choccie", "Chocolate Chip", "Chocolate Pudding",
    "Chocolate", "Choo-Choo", "Chorizo", "Chris", "Chrissy", "Chub", "Churro", "Cielo", "Cilantro", "Cinder", "Cinderblock", "Cinnabon", "Circe", "Cirrus", "Civet", "Clawdette", "Cleffa",
    "Clementine", "Cleo", "Cleopatra", "Clicker", "Clifford", "Cloe", "Cloud", "Clover", "Clyde", "Coal", "Cobweb", "Cocoa Puff", "Cocoa", "Cody", "Coffee", "Cola", "Colby Jack", "Colin Robinson",
    "Comet", "Comfy", "Conan", "Concrete", "Confetti", "Conk Crete", "Connie", "Constructive Criticism", "Cookie", "Cooper", "Coquito", "Coral", "Corazon", "Coriander", "Coricopat", "Corn", "Cosmo",
    "Courage", "Covalent", "Covalent Bond", "Cowbell", "Cowboy", "Cozy", "Crab", "Cracked Earth", "Cracker", "Cream", "Crema", "Crescent", "Crispy", "Crow", "Crumpet", "Crunchwrap", "Crunchy", "Crystal", "Cubby", "Cullen",
    "Cupcake", "Cupid", "Curry", "Cutie", "Cybele", "Cyndaquil", "Cyprus", "Daisy Mae", "Daisuke", "Dakarai", "Dakari", "Dakota", "Dali", "Daliah", "Dambi", "Dan", "Danbi", "Danchu", "Dandelion", "Danger Dave",
    "Dapper", "Darcy", "Darling", "Dasik", "Dave", "Dayo", "Dean", "Deep Dish Pizza", "Deimos", "Deino", "Deirdre", "Deli", "Delilah", "Della", "Demeter", "Destiny", "Dewey", "Diablo", "Diallo",
    "Diamond", "Diana", "Diesel", "Digiorno", "Dimitrescu", "Dinah", "Dino", "Diona", "Dipper", "Dipole", "Dirk", "Disco", "Distinguished Gentleman", "Diva", "Dixie", "Dizzy", "Djungelskog", "Dmitri", "Dobie", "Doc", "Doctor Who",
    "Dog", "Doja", "Dolly", "Domingo", "Dominic", "Domino", "Donald", "Donut", "Donuts", "Doodle", "Doofenshmirtz", "Dori", "Dorian", "Dorothy", "Double Trouble", "Dova", "Dr. Strange", "Draco",
    "Dragon", "Dragonfly", "Draugr", "Dreamy", "Duchess", "Ducky", "Dude", "Dulce", "Dumpling", "Dumpster", "Dune", "Dunnock", "Dust Bunny", "Dusty Cuddles", "Dwarf", "Dysnomia", "Eclipse", "Ed", "Eda",
    "Eddie", "Eden", "Edgar", "Edward", "Eepy", "Eevee", "Egg", "Egypt", "Einar", "Elden", "Electron", "Electronegativity", "Eli", "Elijah", "Elio", "Ellie", "Elliot", "Elton", "Elvis", "Ember", "Emeline", "Emerald", "Emi",
    "Emilio", "Emma", "Emmet", "Emy", "Enchilada", "End", "Ender Dragon", "Endless Reflections", "Endless", "Endothermic", "Endothermic Reaction", "Enoki", "Enthalpy", "Entropy", "Envy", "Erebus", "Erica", "Eris", "Esker", "Esme", "Espeon", "Espresso",
    "Espurr", "Esther", "Etoile", "Europa", "Eva", "Evangeline", "Eve", "Evelyn", "Everest", "Evie", "Evilface", "Exothermic", "Exothermic Reaction", "Extra Cuddles", "Ezra", "Fable", "Failnaught", "Fairy", "Fairytale", "Faizah", "Fallow",
    ...
    "Guillermo", "Guinness", "Gumbo", "Gumi", "Gunnar", "Guppy", "Gus", "Gust", "Gustavo", "Guzma", "Gwendoline", "Gwyndolin", "Gwynn", "Gyoza", "Habanero", "Habibi", "Habika", "Hadar", "Haiku", "Haku",
    "Halcyon", "Hale-Bopp", "Halloween", "Halmey", "Ham", "Hamburger", "Hamlet", "Hantu", "Hanzo", "Harlequin", "Harmony", "Haru", "Harvest", "Harvey", "Hatsune Miku", "Havoc", "Hawkbit", "Hawkeye",
    "Haymitch", "Hazel", "Heat Capacity", "Heathcliff", "Heather", "Hehe", "Heisenberg", "Heli", "Helios", "Helix", "Henry", "Herbert", "Herc", "Hercules", "Hero", "Hershey", "Hex", "Hiccup", "Hickory", "Highness",
    "Hilbert", "Himiko", "Hiyoko", "Hlao", "Hobbes", "Hobohime", "Hocus Pocus", "Holly", "Honda", "Honeydew", "Honeysuckle", "Hop", "Hopper", "Horizon", "Hot Sauce", "Hotdog", "Howdy", "Howler",
    "Hubert", "Hughie", "Hulk", "Human", "Humphrey", "Hunter", "Husker", "Hydra", "Hyeri", "Ice Cube", "Ice Spice", "Ice", "Icecube", "Icee", "Iggy", "Igor", "Ike", "Ikea", "Illari", "Indi", "Indigo",
    "Iniko", "Insect", "Inspector", "Io", "Ion", "Ionic Compound", "Ipsy", "Iron Man", "Isabel", "Isabella", "Isabelle", "Isaiah", "Itsy Bitsy", "Izzy", "Jaakko", "Jack", "Jackal", "Jackie", "Jacko", "Jacques", "Jade", "Jae",
    "Jaffa", "Jaiden", "Jakada", "Jake Gyllenpaws", "Jake", "Jalebi", "Jambo", "James", "Jamilah", "Janis", "Jasmine", "Jason", "Jasper", "Jattelik", "Jattematt", "Jaxon", "Jay", "Jaylen", "Jeep Wrangler",
    "Jelly Jam", "Jelly", "Jellybean", "Jellylorum", "Jemila", "Jenny", "Jennyanydots", "Jerry", "Jesse", "Jessica", "Jessie", "Jester", "Jet", "Jethro", "Jetta", "Jewel", "Jewels", "Jigsaw",
    "Jim", "Jiminy Cricket", "Jimmy", "Jinn", "Jinx", "Jirachi", "Jitters", "Joanne", "John", "Johnny", "Joker", "Jolly Rancher", "Jolly", "Jonas", "Joob", "Jose", "Joy", "Jozi", "Jubie", "Judas",
    "Jude", "Judy", "Julie", "Juliet", "June", "Junkrat", "Juno", "Jupiter", "Kabuki", "Kaede", "Kagamine Len", "Kagamine Rin", "Kai", "Kaia", "Kaito", "Kaizo", "Kale", "Kaleb", "Kamari", "Kamau",
    "Karen", "Kariba", "Karkinos", "Karma", "Kasha", "Kasi", "Kate", "Katjie", "Katniss", "Katy", "KD", "Keanu", "Keiko", "Kellas", "Kelloggs", "Ken", "Kendra", "Kenny", "Kenya", "Kepler", "Kerberos",
    "Kermit", "Kerry", "Ketchup", "Ketsl", "Kettlingur", "Kevin", "Keyboard", "Keziah", "Kianna", "Kiara", "Kibble", "Kid Cat", "Kiki", "Kimani", "Kimberly", "Kimchi", "King", "Kingston", "Kion", "Kip",
    "Kipling", "Kirby", "Kiriko", "Kisha", "Kismet", "Kitty Cat", "Kitty Softpaws", "Kitty", "Kivu", "Kiwi", "Klee", "Klondike", "Knorrig", "Knox", "Koala", "Koba", "Koda", "Kodi", "Kodiak", "Koi",
    "Kokichi", "Kokomi", "Kokum", "Komaru", "Kombucha", "Kong", "Kovu", "Kramig", "Kudu", "Kuma", "Kuromi", "Kushi", "Kyle", "Kyoko", "Kyu", "L", "Laburnum", "Lacy", "Lady Figment", "Lady Liberty",
    "Lady", "Ladybug", "Laika", "Laila", "Lakota", "Laksha", "Laku", "Lapis", "Laranjito", "Larch", "Larimar", "Lark", "Laszlo", "Latte", "Lavender", "Lawn Mower", "Lawrence", "Lazarus", "Lazuli",
    "Leche", "Lee", "Leif", "Lemmy", "Lemon Boy", "Lemon", "Leo", "Leon", "Leonardo", "Lester", "Levi", "Leviathan", "Levon", "Lex", "Li Shang", "Libra", "Lil Baby", "Lilac", "Lilith", "Lilleplutt",
    "Lily", "Limiting Reactant", "Linden", "Lindsey", "Linguine", "Linzhi", "Lionel", "Listens to the Wind", "Litten", "Little Baby", "Little Caesar", "Little Ghost", "Little Guy", "Little Lady", "Little Man", "Little My",
    "Little Nicky", "Little One", "Livlig", "Loaf", "Lobo", "Lobster", "Loca", "Lodesh", "Loki", "Lola", "Lollipop", "Lolly", "Lonardo", "London", "Looks to the Moon", "Looks to the Sky", "Loona",
    "Lora", "Lorado", "Louie", "Louis", "Lovebug", "Loyalty", "Luca", "Luchasaurus", "Luci-Purr", "Lucia", "Luciel", "Lucifur", "Lucio", "Lucky", "Lucy", "Lugnut", "Luigi", "Luke", "Lulu", "Lumi",
    "Lumine", "Luna", "Lunchbox", "Lupo", "Luxio", "Luz", "Lychee", "Lydia", "Lynzi", "Lyric", "Mabel", "Mac", "Macaroon", "Macavity", "Maddy", "Madi", "Madoka", "Maeve", "Maggie", "Magic", "Magikarp",
    "Maiko", "Maize", "Majesty", "Makalu", "Makena", "Makini", "Mako", "Makoto", "Makula", "Makwa", "Malachite", "Maleficent", "Mali", "Malia", "Malik", "Malika", "Mama", "Mamba", "Man With All The Answers",
    ...
    "Ninja", "Nintendo DS", "Nintendo Switch", "Nintendo", "Nirav", "Nirvana", "Nisha", "Nissan", "Nitro", "Nittany", "Niu", "Nix", "Nixie", "Noche", "Noelle", "Noir", "Noodle", "Noodlefly", "Nook",
    "Nori", "Norm", "Norman", "Nottingham", "Nova", "Nucleus", "Nugget", "Nuggets", "Nuka", "Nuri", "Nuru", "Nutella", "Nutmeg", "Nymph", "Nyx", "O'Leary", "Oakley", "Oapie", "Oberon", "Obi Wan",
    "Obsidian", "Octavia", "Octet", "Octet Rule", "October", "Odetta", "Old Deuteronomy", "Old Man Sam", "Oleander", "Olga", "Oliva", "Oliver", "Ollie", "Omelet", "Omen", "Onion", "Onyx", "Oops", "Oopsy Dazey", "Opal",
    "Ophelia", "Orbital", "Orchard", "Oregano", "Oreo", "Orion", "Orisa", "Oryx", "Orzo", "Oscar", "Oscypek", "Oshawott", "Osiris", "Otto", "Outlaw", "Outsider", "Owen", "Ox", "Pablo", "Pachirisu", "Padparadscha",
    "Paella", "Paimon", "Pallas", "Paloma", "Pancake", "Pancho", "Panda", "Pandora", "Pango", "Pangur", "Panini", "Panko", "Paprika", "Papyrus", "Paquito", "Para", "Parhelion", "Pasha", "Pasta",
    "Patches", "Patience", "Paul", "Paulina", "Pavlova", "Pawmi", "Peach", "Peanut Butter", "Peanut Wigglebutt", "Peanut", "Pear", "Pearl", "Pecan", "Peeta", "Pekhult", "Peko", "Penny", "Peony",
    "Pepita", "Pepper", "Pepperjack", "Pepsi", "Pequeno", "Perdito", "Periodic Table", "Periodic Trend", "Peridot", "Periwinkle", "Perrserker", "Perry", "Pesto", "Peter Pan", "Peter Parker", "Peter", "Petya", "Phantom", "Pharah", "Phasmo",
    "Phoenix", "Photon", "Pichi", "Pichu", "Pickles", "Pierogi", "Pierre", "Pietro", "Piggy", "Pigment", "Pikachu", "Pillow", "Pina Colada", "Pineapple", "Ping Pong", "Ping", "Pinkie Pie", "Pinkie", "Pip",
    "Piper", "Pipkin", "Pippin", "Pipsqueak", "Pisces", "Pistol Star", "Pixel", "Pixie", "Pizza Place", "Pizza", "Plague", "Plato", "Playstation", "Plentiful Leaves", "Plot Twist", "Plumeria", "Pluto",
    "Pochito", "Pocket", "Poe", "Poem", "Pokey", "Poki", "Pokotho", "Polaris", "Polka", "Polly", "Polyatomic", "Polyatomic Ion", "Pompompurin", "Pong", "Pongo", "Ponyboy", "Poopy", "Pork Belly", "Porkchop", "Porsche", "Pot Roast",
    ...
    "Rusty", "Ruthie", "Ryos", "Sable", "Sachiko", "Sadie", "Sadiki", "Saeko", "Safari", "Saffron", "Safi", "Sage Marro", "Sagittarius", "Sagwa", "Sahara", "Sahel", "Saidah", "Sailor", "Saint", "Sakari",
    "Saki", "Sakura", "Salem", "Salmon", "Salsa", "Salt", "Salvage", "Sam", "Samantha", "Sambusa", "Samus", "Sanai", "Sandwich", "Sandy", "Sangria", "Sans", "Santana", "Sanyu", "Sapphire", "Sarabi",
    "Sarafina", "Sarah", "Sarek", "Sarge", "Sarki", "Sasha", "Sashimi", "Sassy", "Saturn", "Sausage", "Savannah", "Savvy", "Scampi", "Scarecrow", "Scavenger", "Schmidt", "Scholar", "Scorpio", "Scotch",
    "Scotty", "Scout", "Scribble", "Scrooge", "Scrungle", "Seamus", "Sega", "Sekhmet", "Selkie", "Selkirk", "Seok", "Seoli", "Seoul", "Seraph", "Serengeti", "Serenity", "Sergei", "Sergio", "Seri", "Seven Of Nine",
    ...
    "Strawberry", "Stripes", "Stuffie", "Styx", "Subaru", "Sucrose", "Sueno", "Sugar Plum", "Sugar", "Suhailah", "Summit", "Sundae", "Sunflower", "Sungrazer", "Sunny Meadow", "Sunny", "Sunset",
    "Survivor", "Sushi", "Suya", "Swansea", "Sweet Creature", "Sweet Leon", "Sweet Marmalade", "Sweet", "Sweetie", "Sybil", "Sylvana", "Sylveon", "Sylvester", "Symphony", "Synth", "T-rex", "Tabasco", "Tabatha",
    "Tabby", "Tabbytha", "Taco Bell", "Taco", "Taffy", "Tahini", "Tahir", "Taihu", "Taillow", "Talia", "Tamagotchi", "Tamale", "Tammy", "Tangerine", "Tango", "Tangy", "Tantomile", "Tara", "Tardis",
    "Taro", "Tasha", "Tater Tot", "Tatiana", "Taurus", "Tay", "Tayo", "Tazama", "Teacup", "Techno", "Teddie", "Teddy", "Tempest", "Tempo", "Terabyte", "Tesla", "Tesora", "Tetris", "Tetromino", "Teufel",
    "The Doctor", "The Garlic Lord", "The Narrator", "Theo", "Theodore", "Thermodynamics", "Theta", "Thoko", "Thor", "Thuban", "Thumbelina", "Thyme", "Tia", "Tiana", "Tigger", "Tikka", "Tilin", "Tim Tam", "Times New Roman",
    "Timid Ninja", "Timmy", "Timon", "Tin Man", "Tinka", "Tinky", "Tiny", "Tipsy", "Titan", "Titania", "Tnoy Karaxis", "Toast", "Toastee", "Toby", "Todd Howard", "Todd", "Toffee", "Tofu",
    ...
    "Windy", "Winry", "Winston", "Wishbone", "Wisp", "Wisteria", "Wizard", "Wolfe", "Wolfgang", "Wolverine", "Wonder", "Worm", "Wrath", "X'ek", "Xelle", "Xhosa", "Xiao", "Xola", "Yaoyao", "Yazhu",
    "Yeet", "Yeeted", "Yen", "Yeobo", "Yeza", "Yinuo", "Yippee", "Yogurt", "Yokai", "Yoonmin", "Yooted", "Yoshi", "Yote", "Yuca", "Yuka", "Yuki", "Yumeko", "Yusuke", "Yuzu", "Yvaine", "Zach", "Zachary",
    "Zahra", "Zambezi", "Zambia", "Zaniah", "Zari", "Zariah", "Zarya", "Zazu", "Zebra", "Zekrom", "Zelda", "Zell", "Zendaya", "Zenith", "Zenyatta", "Zephyr", "Zeraora", "Zikomo", "Zim", "Zion", "Zira",
    "Ziti", "Zoe", "Zoomie", "Zorro", "Zorua", "Zuberi", "Zuko", "Zuma", "Zuna", "Zuva"
  ],
	"animal_suffixes": [
